...
- Deze integratie is gebouwd en op syntax gecontroleerd, maar **niet getest tegen een echte meter of een live Home Assistant-installatie** — test dus eerst met één meter voor je de rest toevoegt, en kijk in Instellingen → Systeem → Logboeken als er iets niet meteen werkt.
